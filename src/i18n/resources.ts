  ...
  en: {
    translation: {
      ...
      consent: {
        ...
        description:
          'By using this website, you agree to our use of cookies. Necessary cookies keep ChronoSync running, while preferences and analytics cookies help us remember your settings and improve performance.',
  ...
  es: {
    translation: {
      ...
      consent: {
        ...
        description:
          'Al usar este sitio web, aceptas nuestro uso de cookies. Las cookies necesarias mantienen ChronoSync en funcionamiento, y las cookies de preferencias y analítica nos ayudan a recordar tu configuración y mejorar el rendimiento.',
        ...
        customize: 'Personalizar cookies',
        hideCustomize: 'Ocultar personalización',
        savePreferences: 'Guardar opciones',
      },
      command: {
  ...
  fr: {
    translation: {
      ...
      consent: {
        ...
        description:
          'En utilisant ce site, vous acceptez notre utilisation des cookies. Les cookies nécessaires assurent le fonctionnement de ChronoSync, tandis que les cookies de préférences et analytiques nous aident à mémoriser vos réglages et à améliorer les performances.',
        ...
        acceptAll: 'Je comprends',
        rejectOptional: 'Refuser les optionnels',
        customize: 'Personnaliser les cookies',
  ...
  de: {
    translation: {
      ...
      consent: {
        ...
        description:
          'Durch die Nutzung dieser Website stimmen Sie der Verwendung von Cookies zu. Notwendige Cookies halten ChronoSync funktionsfähig, während Präferenz- und Analyse-Cookies uns helfen, Ihre Einstellungen zu speichern und die Leistung zu verbessern.',
  ...
  hi: {
    translation: {
      ...
      consent: {
        ...
        description:
          'इस वेबसाइट का उपयोग करके, आप हमारे कुकी उपयोग से सहमत होते हैं। आवश्यक कुकीज़ ChronoSync को चलाती हैं, जबकि प्राथमिकता और एनालिटिक्स कुकीज़ आपकी सेटिंग्स याद रखने और प्रदर्शन बेहतर करने में मदद करती हैं।',
        ...
        acceptAll: 'मैं समझता/समझती हूँ',
        rejectOptional: 'वैकल्पिक अस्वीकार करें',
        customize: 'कुकीज़ कस्टमाइज़ करें',
        hideCustomize: 'कस्टमाइज़ेशन छुपाएँ',
        savePreferences: 'चयन सहेजें',
      },
      command: {
        title: 'कमांड पैलेट',
  ...
  zh: {
    translation: {
      ...
      consent: {
        title: 'Cookie 偏好设置',
        description:
          '使用本网站即表示你同意我们使用 Cookie。必要 Cookie 用于保证 ChronoSync 正常运行，偏好和分析 Cookie 可帮助我们记住你的设置并改进性能。',
        ...
        customize: '自定义 Cookie',
        hideCustomize: '隐藏自定义',
        savePreferences: '保存选择',
      },
      command: {
        title: '命令面板',
